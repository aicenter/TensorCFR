...
if __name__ == '__main__':
	...
	with tf.Session() as sess:
		...
		print("########## Level 3 ##########")
		print_tensors(sess, [utilities_lvl3, expected_values[3]])
		print("########## Level 2 ##########")
		print_tensors(sess, [node_strategies_lvl2])
		print_tensors(sess, [utilities_lvl2, expected_values[2]])
		print("########## Level 1 ##########")
		print_tensors(sess, [node_strategies_lvl1])
		print_tensors(sess, [utilities_lvl1, expected_values[1]])
		print("########## Level 0 ##########")
		print_tensors(sess, [node_strategies_lvl0])
		print_tensors(sess, [utilities_lvl0, expected_values[0]])
