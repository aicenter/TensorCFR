...
from src.nn.features.goofspiel.IIGS6.game_constants import FEATURE_COLUMNS, FEATURES_BASENAME, \
...
def get_permutation_by_public_states(verbose=False):
	"""
	:return: The permutation that sorts game nodes of IIGS6 at level 10 by their public states and infosets.
	"""
...
if __name__ == '__main__':
	print("The permutation that sorts game nodes of IIGS6 at level 10 by their public states and infosets:")
