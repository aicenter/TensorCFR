...
class Runner_CNN_Selu_MSELoss_IIGS6Lvl10_TFRecords(Runner_CNN_IIGS6Lvl10_TFRecords):
	def construct_network(self):
		network = ConvNet_Selu_MSELoss_IIGS6Lvl10(threads=self.args.threads, fixed_randomness=self.fixed_randomness)
...
if __name__ == '__main__' and ACTIVATE_FILE:
	runner = Runner_CNN_Selu_MSELoss_IIGS6Lvl10_TFRecords()
