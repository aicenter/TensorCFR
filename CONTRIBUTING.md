...
If you have never created a Pull Request, follow the guide [Making a Pull Request](https://www.atlassian.com/git/tutorials/making-a-pull-requesthttps://www.atlassian.com/git/tutorials/making-a-pull-request).
4. It is highly recommended to [sign all your commits with GPG](https://gitlab.com/help/user/project/repository/gpg_signed_commits/index.md).
