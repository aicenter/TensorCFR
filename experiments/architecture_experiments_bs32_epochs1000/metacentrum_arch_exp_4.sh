...
ARCH="--extractor C-$(($FEATURES_DIM*6)),C-$(($FEATURES_DIM*6)),C-$(($FEATURES_DIM*5)),C-$(($FEATURES_DIM*5))
--regressor C-$(($FEATURES_DIM*5)),C-$(($FEATURES_DIM*5)),C-$(($FEATURES_DIM*4)),C-$(($FEATURES_DIM*4))"
