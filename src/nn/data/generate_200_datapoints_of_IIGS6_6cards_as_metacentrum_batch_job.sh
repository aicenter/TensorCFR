...
#  qsub generate_200_datapoints_of_IIGS6_6cards_as_metacentrum_batch_job.sh

# configure variables
FRONTNODE_HOME="/storage/plzen1/home/mathemage"
REPO_DIR="${FRONTNODE_HOME}/beyond-deepstack/TensorCFR"
FRONTNODE_DATA="${FRONTNODE_HOME}/beyond-deepstack/data/IIGS6/200_datapoints"
DATASET_DIR="${SCRATCHDIR}/TensorCFR/src/nn/data/out/IIGS6/200_datapoints"
...
# run TensorCFR
cd TensorCFR
python -m src.nn.data.generate_data_of_IIGS6_200x
