...
from domain.domain_01 import reach_probabilities_lvl0, node_to_IS_lvl0, IS_strategies_lvl0, node_to_IS_lvl1, \
	IS_strategies_lvl1, node_to_IS_lvl2, IS_strategies_lvl2, utilities_lvl0, utilities_lvl1, utilities_lvl2
...
with tf.Session() as sess:
	...
	# more verbose output
	print("########## Level 0 ##########")
	print_tensors(sess, [utilities_lvl0, node_to_IS_lvl0, IS_strategies_lvl0, node_strategies_lvl0])
	print("########## Level 1 ##########")
	print_tensors(sess, [utilities_lvl1, node_to_IS_lvl1, IS_strategies_lvl1, node_strategies_lvl1])
	print("########## Level 2 ##########")
	print_tensors(sess, [utilities_lvl2, node_to_IS_lvl2, IS_strategies_lvl2, node_strategies_lvl2])
	# print("########## Level 3 ##########")
