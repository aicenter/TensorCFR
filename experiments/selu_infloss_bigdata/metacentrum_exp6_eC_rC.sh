...
EXPERIMENT_NAME="ConvNet_Selu_InfinityLoss_IIGS6Lvl10_bs1_"
...
ARCH="--extractor C-$(($FEATURES_DIM*2)),C-$(($FEATURES_DIM*2))
--regressor C-$(($FEATURES_DIM*2))"
CMD="${PYTHON} -m src.nn.Runner_CNN_Selu_InfinityLoss_IIGS6Lvl10_TFRecords ${COMMON_ARGS} ${ARCH}"
