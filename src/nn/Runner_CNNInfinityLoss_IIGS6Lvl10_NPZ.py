...
from src.nn.ConvNetInfinityLoss_IIGS6Lvl10 import ConvNetInfinityLoss_IIGS6Lvl10
...
class Runner_CNN_IIGS6Lvl10_NPZ(AbstractNNRunner):
	...
	def default_extractor_arch(self):
		return "C-{}".format(ConvNetInfinityLoss_IIGS6Lvl10.INPUT_FEATURES_DIM)
	...
	def construct_network(self):
		network = ConvNetInfinityLoss_IIGS6Lvl10(threads=self.args.threads, fixed_randomness=self.fixed_randomness)
