#!/bin/bash
#PBS -N ConvNet_IIGS6Lvl10__hyp_opt_3_npz
#PBS -q gpu
...
ARCH="--extractor C-$(($FEATURES_DIM*5)),C-$(($FEATURES_DIM*5)),C-$(($FEATURES_DIM*5))
--regressor C-$(($FEATURES_DIM*10)),C-$(($FEATURES_DIM*10)),C-$(($FEATURES_DIM*9)),C-$(($FEATURES_DIM*9))
,C-$(($FEATURES_DIM*7)),C-$(($FEATURES_DIM*7)),C-$(($FEATURES_DIM*5)),C-$(($FEATURES_DIM*5))"
