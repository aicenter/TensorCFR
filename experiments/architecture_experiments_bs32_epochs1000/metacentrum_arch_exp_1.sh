...
ARCH="--extractor C-$(($FEATURES_DIM*4)),C-$(($FEATURES_DIM*4)),C-$(($FEATURES_DIM*4)),C-$(($FEATURES_DIM*3)),C-$(($FEATURES_DIM*3)),C-$(($FEATURES_DIM*3))
--regressor C-$(($FEATURES_DIM*3)),C-$(($FEATURES_DIM*3))"
