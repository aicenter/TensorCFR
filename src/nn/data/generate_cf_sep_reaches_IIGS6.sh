...
FRONTNODE_DATA="${FRONTNODE_HOME}/beyond-deepstack/data/IIGS6/IIGS6_cf_sep_reach"
DATASET_DIR="${SCRATCHDIR}/TensorCFR/src/nn/data/out/IIGS6_cf_sep_reach"
...
# run TensorCFR
cd TensorCFR
python -m src.nn.data.generate_ranges_of_lvl10_IIGS6
