...
CUDA_VISIBLE_DEVICES=1 ${PYTHON} -m ${SCRIPT} ${COMMON_ARGS} ${ARCH} &>tensorcfr_CNN_IIGS6_td10_online_training.out.1_layers

# 2 layers
ARCH="--extractor C-46,C-46 --regressor C-138,C-138"
CUDA_VISIBLE_DEVICES=1 ${PYTHON} -m ${SCRIPT} ${COMMON_ARGS} ${ARCH} &>tensorcfr_CNN_IIGS6_td10_online_training.out.2_layers

# 3 layers
ARCH="--extractor C-46,C-46,C-46 --regressor C-138,C-138,C-138"
CUDA_VISIBLE_DEVICES=1 ${PYTHON} -m ${SCRIPT} ${COMMON_ARGS} ${ARCH} &>tensorcfr_CNN_IIGS6_td10_online_training.out.3_layers

# 5 layers
ARCH="--extractor C-46,C-46,C-46,C-46,C-46 --regressor C-138,C-138,C-138,C-138,C-138"
CUDA_VISIBLE_DEVICES=1 ${PYTHON} -m ${SCRIPT} ${COMMON_ARGS} ${ARCH} &>tensorcfr_CNN_IIGS6_td10_online_training.out.5_layers

# 7-layers
ARCH="--extractor C-46,C-46,C-46,C-46,C-46,C-46,C-46 --regressor C-138,C-138,C-138,C-138,C-138,C-138,C-138"
CUDA_VISIBLE_DEVICES=1 ${PYTHON} -m ${SCRIPT} ${COMMON_ARGS} ${ARCH} &>tensorcfr_CNN_IIGS6_td10_online_training.out.7_layers
