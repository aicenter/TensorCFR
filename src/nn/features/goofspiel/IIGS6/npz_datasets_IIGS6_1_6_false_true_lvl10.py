...
from src.nn.features.goofspiel.IIGS6.game_constants import FEATURE_COLUMNS, TARGET_COLUMNS, FEATURES_BASENAME, \
	NAMES_OF_FEATURE_CSV, N_CARDS, SLICE_1HOT_FEATS
