...
from src.nn.ConvNet_Selu_MSELoss_IIGS6Lvl10 import ConvNet_Selu_MSELoss_IIGS6Lvl10
from src.nn.data.DatasetFromNPZ import DatasetFromNPZ


class Runner_CNN_Selu_MSELoss_IIGS6Lvl10_NPZ(AbstractNNRunner):
	@property
	def default_extractor_arch(self):
		return "C-{}".format(ConvNet_Selu_MSELoss_IIGS6Lvl10.INPUT_FEATURES_DIM)
	...
	def init_datasets(self, dataset_directory):
		...
		devset, testset, trainset = Runner_CNN_Selu_MSELoss_IIGS6Lvl10_NPZ.datasets_from_npz(dataset_directory, script_directory)
		return devset, testset, trainset

	def construct_network(self):
		network = Runner_CNN_Selu_MSELoss_IIGS6Lvl10_NPZ(threads=self.args.threads, fixed_randomness=self.fixed_randomness)
...
if __name__ == '__main__' and ACTIVATE_FILE:
	runner = Runner_CNN_Selu_MSELoss_IIGS6Lvl10_NPZ()
