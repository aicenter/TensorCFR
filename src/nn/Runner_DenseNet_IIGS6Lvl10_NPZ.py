...
from src.nn.DenseNet_IIGS6Lvl10 import DenseNet_IIGS6Lvl10
...
class Runner_DenseNet_IIGS6Lvl10_NPZ(Runner_CNN_IIGS6Lvl10_NPZ):
	@property
	def default_extractor_arch(self):
		return "C-{}".format(DenseNet_IIGS6Lvl10.FEATURES_DIM)
	...
	def init_datasets(self, dataset_directory):
		...
		devset, testset, trainset = Runner_DenseNet_IIGS6Lvl10_NPZ.datasets_from_npz(dataset_directory, script_directory)
		return devset, testset, trainset

	def construct_network(self):
		self.network = DenseNet_IIGS6Lvl10(threads=self.args.threads)
...
if __name__ == '__main__' and ACTIVATE_FILE:
	...
	runner = Runner_DenseNet_IIGS6Lvl10_NPZ()
	runner.run_neural_net(ckpt_every=2)

	runner_from_ckpt = Runner_DenseNet_IIGS6Lvl10_NPZ()
