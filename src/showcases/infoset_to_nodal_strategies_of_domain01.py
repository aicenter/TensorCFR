...
from src.domains.domain01.domain01 import current_infoset_strategies, node_to_infoset, acting_depth
...
with tf.Session() as sess:
	...
	for level in range(acting_depth):
		...
		print_tensors(sess, [node_to_infoset[level], current_infoset_strategies[level], node_strategies[level]])
